...
INSERT IGNORE INTO usuario (email, clave, tipo_id)
VALUES ('admin1@poketienda.com', '1234', 2);
...
INSERT IGNORE INTO tipo_usuario (id, denominacion)
VALUES (1, 'Básico'), (2, 'Administrador');
